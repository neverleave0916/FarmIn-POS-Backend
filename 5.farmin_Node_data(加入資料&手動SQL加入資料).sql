...
INSERT INTO `transaction_src` (`transaction_src_id`, `transaction_src_name`, `transaction_src_desc`, `deleted_at`) VALUES ('TSRC01', 'POS1', 'POS機1', NULL), ('TSRC02', 'APP', '手機APP', NULL);
INSERT INTO `transaction_status` (`transaction_status_id`, `transaction_status_name`, `transaction_status_desc`, `deleted_at`) VALUES ('TSTAT01', '待取貨', NULL, NULL), ('TSTAT02', '已完成', NULL, NULL);
INSERT INTO `payment_type` (`payment_type_id`, `payment_type_title`, `payment_type_desc`, `deleted_at`) VALUES ('PM01', '現金', NULL, NULL), ('PM02', '行動支付', 'APP付款', NULL);

INSERT INTO `transaction` (`transaction_id`, `member_id`, `transaction_src_id`, `transaction_status_id`, `payment_type_id`, `transaction_create_dt`, `transaction_subtotal`, `transaction_discount`, `transaction_total`, `transaction_paid`, `transaction_pay_dt`, `transaction_remark`, `deleted_at`) 
VALUES 
('TX2020082000001', 'M10001', 'TSRC01', 'TSTAT01', 'PM01', '2020-08-20 00:00:00', '200', '0', '200', '200', '2020-08-20 00:00:00', NULL, NULL), 
('TX2020082000002', 'M10001', 'TSRC02', 'TSTAT01', 'PM01', '2020-08-20 00:00:00', '100', '0', '100', '100', '2020-08-20 00:00:00', NULL, NULL);

INSERT INTO `transaction_participate_product` (`transaction_id`, `product_id`, `transaction_participate_product_unit`, `transaction_participate_product_amount`, `transaction_participate_product_unit_price`, `deleted_at`)
VALUES
('TX2020082000001', 'PD0001', '包', '3', '40', NULL),
